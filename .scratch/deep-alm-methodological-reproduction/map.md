...
- [28 Run the bounded paired-convention pilot matrix](../deep-alm-methodological-reproduction-implementation/issues/28-run-paired-convention-pilot-matrix.md): Ready to implement the explicit M5 resource-bounded Paper/Corrected BM^D/MM pilot.
